...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Aventureiro Missão = new iniciarMissao
        ...
        while (Start == true) {
            int selecao = Integer.parseInt(JOptionPane.showInputDialog("1. Registro de Aventureiros \n" +
                    ...
                    "4. Sair"));
            if(selecao == 1) {
                int registroAventureiros = Integer.parseInt(JOptionPane.showInputDialog("1. Cadastrar Aventureiros \n"
                        +	"2. Buscar Aventureiros \n"
                        +   "3. Alterar Rank"
                ));
                if(registroAventureiros == 1) {
                    int selecaoClasse = Integer.parseInt(JOptionPane.showInputDialog(   "Qual a classe do aventureiro ? \n"
                            +   "1. Assassino \n"
                            +	"2. Guerreiro \n"
                            +   "3. Mago"));
                    ...
                    if(selecaoClasse == 1) {
                        ...
                        numeroDeRegistro = Integer.parseInt(JOptionPane.showInputDialog("Qual o numero de registro dele ? "));
                        ...
                        resistenciaMagica = Integer.parseInt(JOptionPane.showInputDialog("Quanta resistencia magica ele possui? "));
                        danoLetal = Integer.parseInt(JOptionPane.showInputDialog("Quanto de dano letal extra ele causa?: "));

                        newguilda.cadastraAssassino(nome, genero, idade, altura, numeroDeRegistro, primeiraSkill, segundaSkill, terceiraSkill, quartaSkill, ultimateSkill, tipoDeDano, dano, armadura, resistenciaMagica, danoLetal);
                    }
                        ...
                        armadura = Integer.parseInt(JOptionPane.showInputDialog("Quanto de armadura ele tem ? "));
                        resistenciaMagica = Integer.parseInt(JOptionPane.showInputDialog("Quanta resistencia magica ele possui? "));
                        PassivaDefesa = Integer.parseInt(JOptionPane.showInputDialog("Quanto de armadura extra ele recebe? "));

                        newguilda.cadastraGuerreiro(nome, genero, idade, altura, numeroDeRegistro, primeiraSkill, segundaSkill, terceiraSkill, quartaSkill, ultimateSkill, tipoDeDano, dano, armadura, resistenciaMagica, PassivaDefesa);
                        ...
                        newguilda.cadastraGuerreiro(nome, genero, idade, altura, numeroDeRegistro, primeiraSkill, segundaSkill, terceiraSkill, quartaSkill, ultimateSkill, tipoDeDano, dano, armadura, resistenciaMagica, curar);
                    ...
                    JOptionPane.showMessageDialog(null, "Essa é a ficha do aventureiro que vc procura: " + (newguilda.buscarAventureiro(IdAventureiro)));
                ...
                if(quadroDeMissoes == 1) {
                    ...
                    dificuldade = Integer.parseInt(JOptionPane.showInputDialog("Qual o nivel de dificuldade da missão? "));
                    idItem = Integer.parseInt(JOptionPane.showInputDialog("Qual o id do item ? "));
                    numeroMissao = Integer.parseInt(JOptionPane.showInputDialog("Qual o numero de registro da missão? "));
                    newguilda.cadastraMissao(tituloDaMissao, dificuldade, idItem, numeroMissao);
                }
                else if(quadroDeMissoes == 2) {
                    numeroMissao = Integer.parseInt(JOptionPane.showInputDialog("Qual o numero de registro da missão? "));
                    JOptionPane.showMessageDialog(null, "Essa missão está no mural: " + newguilda.buscarMissao(numeroMissao));
                    ...
                    Missao missao1 = newguilda.buscarMissao(Integer.parseInt(JOptionPane.showInputDialog("Qual missão vamos cumprir hoje?:(numero de registro da missão) ")));
                    Aventureiro aventureiro = newguilda.buscarAventureiro(Integer.parseInt(JOptionPane.showInputDialog("Qual aventureiro vai iniciar na missão?:(numero de registro do aventureiro) ")));
                    int usar = Integer.parseInt(JOptionPane.showInputDialog("Voce deseja usar um item? \n"
                            + "1. Sim \n"
                            + "2. Não"));
                    if (usar == 1 && aventureiro.getBolsa().size()>=1) {
                        ItemClasse item = newguilda.buscarItem(Integer.parseInt(JOptionPane.showInputDialog("Qual o numero de registro do item? ")));
                        aventureiro.usarItem(item);
                    }
                    else {
                        JOptionPane.showMessageDialog(null, "Parece que sua bolsa furou. Boa Sorte!!! ");
                    ...
                    for(int i = 0; i <= 1; ++i){
                        ...
                        if (entradaSkill == 1 || entradaSkill == 3) {
                            ...
                            JOptionPane.showMessageDialog(null, "Boss a defetede\n"
                            ...
                            JOptionPane.showMessageDialog(null, "Fugiu com o rabo entre as pernas, covarde. GIT GUD SCRUB!!!");
                            missao1.falharMissao();
                            break;
                        }
                    }
                ...
                int armazemDaGuilda = Integer.parseInt(JOptionPane.showInputDialog("1. Cadastrar Item \n"
                        +	   "2. Buscar Item \n"
                        +      "3. Remover Item"));
                if(armazemDaGuilda == 1) {
                    ...
                    numeroDoItem = Integer.parseInt(JOptionPane.showInputDialog("Qual o numero de registro do item? "));
                    JOptionPane.showMessageDialog(null, "o item que você busca é: " + newguilda.buscarItem(numeroDoItem));
                }
